  ...
  render (counter) {
    const html = `
      <div class="header__container">
        <nav class="nav">
        <a href="http:"/index.html"><h3>Shot<span>Shop</span></h3></a>
          ...
          <div class="dropdown">
              ...
              <ul class="dropdown-menu menu_menu" aria-labelledby="dropdownMenuButton1">
                <li><a class="dropdown-item menu_li" href="/index.html">Main</a></li>
                <li><a class="dropdown-item menu_li" href="/catalog.html">All skins</a></li>
                <li><a class="dropdown-item menu_li" href="/basket.html">Basket</a></li>
              </ul>
          </div>
